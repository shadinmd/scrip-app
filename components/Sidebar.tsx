  ...
  return (
    <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 1000 }}>
      ...
      <Animated.View 
        ...
        className="shadow-2xl border-r border-border"
      >
        ...
        {/* User Info */}
        <View className="px-6 py-4 bg-muted/20 border-y border-border/50">
          <View className="flex-row items-center gap-3">
            ...
            <View className="flex-1">
              <Text className="text-lg font-bold" numberOfLines={1}>{user?.username}</Text>
        ...
        <View className="p-6 border-t border-border/50">
          ...
          >
            ...
            <Text className="text-destructive font-bold text-lg">Logout</Text>
          </TouchableOpacity>
          <Text className="text-center text-xs text-muted-foreground mt-6 font-medium">
            Version 1.0.0
          </Text>
        </View>
      </Animated.View>
